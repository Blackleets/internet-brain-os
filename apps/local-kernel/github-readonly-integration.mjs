...
function assertActiveAuthorization(receipt, capability, now) {
  ...
  if (Date.parse(receipt.expiresAt) <= now.getTime()) throw new GitHubIntegrationError('GITHUB_AUTHORIZATION_EXPIRED', 'GitHub authorization expired and must be renewed.', 403);
