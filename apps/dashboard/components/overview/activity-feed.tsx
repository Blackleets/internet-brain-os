...
const stateLabels: Record<string, string> = { active: 'Activa', new: 'Nueva', waiting_for_agent: 'Esperando agente', queued: 'En cola', running: 'En ejecucion', investigating: 'Investigando', verifying: 'Verificando', forged: 'Forjada', completed: 'Completada', completed_without_forge: 'Terminada sin Evidence', research_completed: 'Investigación terminada', failed: 'Fallida' };
