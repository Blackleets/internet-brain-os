...
export function OverviewScreen({ snapshot, reload, disconnect, actions }: OverviewScreenProps) {
  ...
  return <>
    ...
    <div><OpportunityPanel opportunities={snapshot.opportunities} missions={snapshot.missions} unavailable={hasIssue(snapshot.issues, 'opportunities')} /></div>
