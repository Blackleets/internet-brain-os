...
export class InvalidEvidenceInputError extends Error {
  ...
  constructor(readonly field: InvalidEvidenceInputField, readonly value: unknown, message: string) {
    super(message);
...
export class StaleEvidenceUpdateError extends Error {
  ...
  constructor(readonly evidenceId: EvidenceId, readonly provided: IsoDateTime, readonly stored: IsoDateTime) {
...
export class ArchivedCaseEvidenceLinkError extends Error {
  ...
  constructor(readonly evidenceId: EvidenceId, readonly caseId: CaseId) {
